...
const generateReviewsAI = async (product, quantity = 4) => {
    const prompt = `
        ...
        Cada reseña debe tener estos campos:
            1. **reviewer**: El nombre del autor.
        ...
        [
            { "reviewer": "Ricardo F.", "rating": 5, "review": "Excelente compra, llegó súper rápido." },
            { "reviewer": "Ana M.", "rating": 5, "review": "Desde que uso estas plantillas, mis pies están mucho mejor..." }
        ]
